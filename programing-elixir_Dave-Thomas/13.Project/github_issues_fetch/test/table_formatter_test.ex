defmodule TableFormatterTest do
  ...
  alias Export.TableFormatter, as: TF
  ...
  test "split_into_columns" do
    ...
    assert List.first(columns) == [ c1: "r2 c1", c2: "r2 c2", c3: "r2 c3", c4: "r2 c4" ]
    assert List.last(columns) == [ c1: "r1 c1", c2: "r1 c2", c3: "r1 c3", c4: "r1+++c4" ]
  end

  test "column_widths" do
    widths = TF.widths_of_columns(split_with_three_columns())
    assert widths == [ 5, 6, 7 ]
  end
